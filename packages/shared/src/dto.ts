 ...
 * These are structural types only — no runtime dependencies.
 */
import type {
  AttemptStatus,
  BookingStatus,
...
/** Question as delivered to a student — never contains the answer key. */
...
/** Authoring shape — contains the answer key, admin/teacher only. */
...
export interface QuizAttemptState {
  ...
  startedAt: string;
  /** Server-authoritative deadline. Clients only render the countdown. */
  expiresAt: string;
...
export type QuizAnswerValue =
  ...
  | { type: 'FILE'; mediaId: string; fileName: string };

export interface QuizAnswerInput {
  questionId: string;
  value: QuizAnswerValue;
  /** Client monotonic clock for offline conflict resolution. */
